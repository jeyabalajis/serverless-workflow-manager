...
A **lightweight** yet **powerful**, _event driven_ workflow orchestration manager for micro-services. Built based on [orchestration-based saga pattern](https://microservices.io/patterns/data/saga.html) using [hexagonal architecture](https://beyondxscratch.com/2017/08/19/hexagonal-architecture-the-practical-guide-for-a-clean-architecture/).
